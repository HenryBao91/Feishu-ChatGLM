    ...
    def handle_message(self, chat_event: ChatEvent):
        ...
        if "text" in content:
            ...
            if len(db_history) == 0:
                ...
                # return self.message_sender.send_textX_message(
                ...
                # return self.message_sender.send_text_message(chat_event.sender_user_id, response,
                #                                              chat_id=chat_event.chat_id
                #                                              )
                # return self.message_sender.send_textX_message(chat_event.chat_id, response)
